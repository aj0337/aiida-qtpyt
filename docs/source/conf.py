#
# Sphinx configuration for aiida-qtpyt
#
...
copyright_owners = "Anooja Jayaraj"
...
release = aiida_qtpyt.__version__
...
html_title = f"aiida-qtpyt v{release}"
html_theme_options = {}
...
html_use_opensearch = "https://aiida-qtpyt.readthedocs.io"
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, "aiida_qtpyt")
